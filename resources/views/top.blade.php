<hr><div style="text-align: center; float: left; width: 33%; background-color: skyblue;">화령 송어장</div>
<div id="clock" style=" text-align:center; float:left; width: 33%; background-color: skyblue;">현재 시간</div>
<div id="sales" style="text-align: center; float: left; width: 33%; background-color: skyblue;">오늘의 매출액 : </div>
<br><hr>
<script>
